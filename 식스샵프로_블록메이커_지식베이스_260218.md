...
## 0) 탭 3개 고정
- TAB: '콘텐츠' / '디자인' / '개발자'
- 콘텐츠 탭: 운영자용(비개발자) 설정이다. 기본 콘텐츠 탭만 노출된다.
- 디자인/개발자 탭: 운영자가 실수로 조작하는 것을 방지하기 위해 '개발자 옵션보기'항목에 체크했을 때만 하위 옵션들을 보여준다.
...
## 6) 개발자 모드 노출 규칙(필수)
- '개발자 옵션보기' CHECKBOX는 항상 존재
- 기본값 false
- 디자인/개발자 탭의 모든 옵션은 '개발자 옵션보기'항목에 체크했을 때만 노출
